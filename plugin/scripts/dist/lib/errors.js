...
(function (ErrorCode) {
    // AWS CLI errors
    ErrorCode["AWS_CLI_NOT_FOUND"] = "AWS_CLI_NOT_FOUND";
    ErrorCode["AWS_CLI_ERROR"] = "AWS_CLI_ERROR";
    // Authentication errors
    ErrorCode["CREDENTIALS_EXPIRED"] = "CREDENTIALS_EXPIRED";
    ErrorCode["CREDENTIALS_INVALID"] = "CREDENTIALS_INVALID";
    ErrorCode["SSO_SESSION_EXPIRED"] = "SSO_SESSION_EXPIRED";
    ErrorCode["PROFILE_NOT_FOUND"] = "PROFILE_NOT_FOUND";
    // Permission errors
    ErrorCode["ACCESS_DENIED"] = "ACCESS_DENIED";
    ErrorCode["BEDROCK_ACCESS_DENIED"] = "BEDROCK_ACCESS_DENIED";
    // Network errors
    ...
    ErrorCode["CONFIG_CORRUPTED"] = "CONFIG_CORRUPTED";
    // Validation errors
 ...
 */
export function parseAwsError(stderr, exitCode) {
 ...
 */
export function createConfigError(issue, details) {
    switch (issue) {
        case 'corrupted':
            return {
