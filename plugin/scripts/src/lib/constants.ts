...
export const INFERENCE_PRESETS: Record<Exclude<InferencePresetName, 'custom'>, InferencePreset> = {
  focused: {
    name: 'focused',
    label: 'Focused',
    thinkingTokens: 4096,
 ...
 */
export const DEFAULT_INFERENCE_PRESET: StandardPresetName = 'balanced';
